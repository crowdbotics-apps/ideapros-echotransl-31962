...
## Project Structure
    ...
    ├── ideapros_echotransl_31962  # Django project configurations
...
1. Clone this repo and `cd ideapros_echotransl_31962`
...
2. Clone this repo and `cd ideapros_echotransl_31962`
